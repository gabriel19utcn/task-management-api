...
from app.models.task import TaskStatus, TaskType, RecurrenceInterval
...
class RecurringIn(BaseModel):
    ...
    interval_value: int = Field(ge=0, le=1440)  # 0 = run once, 1+ = recurring with interval
    ...
    def validate_interval_value(cls, v, values):
        ...
        if interval_type == RecurrenceInterval.minutely and v > 1440:  # Max 24 hours in minutes
            raise ValueError('minutely interval_value cannot exceed 1440 (24 hours)')
        elif interval_type == RecurrenceInterval.hourly and v > 720:  # Max 30 days in hours
